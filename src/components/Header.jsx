    ...
    <header className="fixed z-50 w-screen p-3 px-8 md:p-6 md:px-16 bg-primary">
      ...
      <div className="hidden md:flex w-full h-full items-center justify-between">
        <Link to={"/"} className="flex items-center gap-2">
          ...
          <p className="text-headingColor text-xl font-bold">food store</p>
        </Link>
        <div className="flex items-center gap-8">
          ...
          <div className="relative">
            ...
            {isMenu && (
              ...
              top-12 right-0"
              >
                {user && user.email === "arfimiaw114@gmail.com" && (
                  <Link to={"/createitem"}>
                    <p
          ...
          {isMenu && (
            ...
            >
              ...
              <ul className="flex flex-col px-4 ">
                <li
                  className="text-base text-textColor hover:text-headingColor duration-100 
                transition-all ease-in-out cursor-pointer hover:bg-slate-100 py-2"
                  onClick={() => setIsMenu(false)}
                >
                  Home
                </li>
              ...
              <p
                className="m-2 p-2 rounded-md shadow-md flex items-center gap-3 cursor-pointer hover:bg-gray-300
